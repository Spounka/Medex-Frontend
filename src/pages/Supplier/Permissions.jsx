        ...
        await api
            .post(
                import.meta.env.VITE_BACKEND_URL +
                    "/api/account/supplier/employee/register/",
                {
                    full_name: name,
                    email,
                    password,
            ...
            .then(() => {
                ...
                toast.success(
                    "You have successfully created a new employee for your company"
                );
            })
            .catch((err) => {
                ...
                if (Object.keys(errors).indexOf("email") > -1) {
                    ...
                    toast.error(
                        "There was an error with creating a new employee, please try again later"
                    );
                }
            });
    };
