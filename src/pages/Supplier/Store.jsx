              ...
              <div className="col-lg-12 mt-3">
                <div className="card" style={{ border: "none" }}>
                  <div className="card-title p-4 pb-0 profile__title">
                    <h3>{t("supplier_pages.setting.storeDetails")}</h3>
                  </div>
                      ...
                      <form method="post" onSubmit={handlesubmit}>
                        <div className="row mb-3 d-flex align-items-center">
                          <div className="col-sm-3">
                            <h6 className="mb-0 d-flex align-items-center gap-2">
                              ...
                              {t("supplier_pages.setting.storeName")} *
                            </h6>
                          </div>
                        ...
                        <div className="row mb-3 d-flex align-items-center">
                          <div className="col-sm-3">
                            <h6 className="mb-0 d-flex align-items-center gap-2">
                              <CiLink size="1.8rem" />
                              {t("supplier_pages.setting.storeWebsite")}
                            </h6>
                          </div>
                          <div className="col-sm-9 text-secondary">
                            <input
                        ...
                        <div className="row mb-3 d-flex align-items-center">
                          <div className="col-sm-3">
                            <h6 className="mb-0 d-flex align-items-center gap-2">
                              ...
                              {t("supplier_pages.setting.storeEmail")} *
                            </h6>
                          </div>
                          <div className="col-sm-9 text-secondary">
                            <input
                        ...
                        <div className="row mb-3 d-flex align-items-center">
                          <div className="col-sm-3">
                            <h6 className="mb-0 d-flex align-items-center gap-2">
                              ...
                              {t("supplier_pages.setting.storePhone")} *
                            </h6>
                          </div>
                          <div className="col-sm-9 text-secondary">
                            <PhoneInput
                        ...
                        <div className="row mt-5">
                          ...
                          <div className="col-sm-9 text-secondary">
                            ...
                            >
                              {t("supplier_pages.setting.editStore")}
