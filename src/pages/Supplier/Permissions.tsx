...
const Permissions = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        await api
            .post(import.meta.env.VITE_BACKEND_URL + "/api/account/supplier/employee/", {
                full_name: name,
                email,
                password,
    ...
    const getEmployees = async () => {
        await api
            .get(import.meta.env.VITE_BACKEND_URL + "/api/account/supplier/employee/")
            .then((res) => {
    ...
    const handleDelete = async (employee_id) => {
        await api
            .delete(
                import.meta.env.VITE_BACKEND_URL + "/api/account/supplier/employee/",
                {
                    data: { employee_id },
                },
            )
