                        ...
                        >
                          <div className="row">
                            <div className="col-2 col-md-1 my-auto">
                              <img
                                src={
                                  quote.user.profile.profilePicture
                            ...
                            <div className="col-9 col-md-10 mx-2">
                              <div className="card-body">
                                ...
                                <span className="card-text dashboard__quote-text">
                                  {quote.requirements.substring(0, 30)}
                                </span>
                              </div>
                            </div>
                          </div>
                          <div className="d-flex align-items-center justify-content-between">
                            <div className="d-flex align-items-center gap-2 dashboard__quote-info">
                              ...
                              {quote.quantity} {quote.unit_display}
                            </div>
                            <div className="d-flex align-items-center gap-2 dashboard__quote-info">
                              <CiTimer size=".8rem" />
                      ...
                      return (
                        <div
                          className={`tab-pane fade ${
                            selectedQuote.id == quote.id ? "active show" : ""
                          }`}
                          id={`list-${quote.id}`}
                          role="tabpanel"
                          ...
                          <div className="card p-3 shadow" style={{minWidth: '300px'}}>
                            <div className="d-flex align-items-center gap-4 mb-3">
                              ...
                              <div className="d-flex flex-column gap-2">
                                <h4 className="m-0">{quote.user.full_name}</h4>
                                <p className="m-0">{quote.user.email}</p>
                              </div>
                            </div>
                            <h5 className="mb-3">{quote.product_name}</h5>
                            <p className="mb-3">{quote.requirements}</p>
                            <h5 className="fw-bold mb-3">
                              {t("buyer_pages.quote_requests.det")}
                            </h5>
                            ...
                            <hr />
                            <h5 className="fw-bold mb-3">
                              {t("supplier_pages.quote_list.offer")}
                            </h5>
                            <button
                              type="button"
                            ...
                            >
                              {t("supplier_pages.quote_list.submit")}
                                    ...
                                    >
                                      <div className="mb-3">
                                        ...
                                        >
                                          ...
                                          {t("supplier_pages.quote_list.qty")}*
                                        </label>
                                        <input
                                          type="number"
                                          id="quantity"
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          ...
                                          {t("supplier_pages.quote_list.brand")}
                                          *
                                        </label>
                                        <CreatableSelect
                                          required
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          <GrMoney size="1.4rem" />
                                          {t("supplier_pages.quote_list.tax")}%
                                          *
                                        </label>
                                        <input
                                          type="number"
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          ...
                                          {t("supplier_pages.quote_list.date")}*
                                        </label>
                                        <input
                                          type="date"
                                          id="Delivery Date"
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          ...
                                          {t("supplier_pages.quote_list.pay")}*
                                        </label>
                                        <input
                                          type="text"
                                          id="payment_type"
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          <GrNote size="1.1rem" />
                                          {t("supplier_pages.quote_list.note")}
                                        </label>
                                        <textarea
                                          id="notes"
                                          className="form-control"
                                      ...
                                      <div className="mb-3">
                                        ...
                                        >
                                          {t("supplier_pages.quote_list.send")}
