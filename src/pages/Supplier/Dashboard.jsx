    ...
    await api
      ...
      .then((res) => {
        ...
        setPercentagePreviousMonthlySales(
          Math.round(parseFloat(res.data.results.stats.monthly_sales[1]))
        );
              ...
              <div className="p-4 dashboard__stats-card">
                <div className="row">
                  <div className="col-9">
                    ...
                    <div className="d-flex align-items-center gap-3">
                      <h2 className="d-flex align-items-center mb-0  dashboard__stats-card-text">
                        {monthlySales > 0 ? monthlySales : 0} {t("sar")}
                      </h2>
                      <div
                        className="d-flex align-items-center gap-1 px-3 py-1"
                        style={
                      ...
                      {orderItems.map((order) => {
                        return (
                          <tr key={order?.id}>
                            ...
                            <td className="text-nowrap">{order?.quantity}</td>
                            <td className="text-nowrap">
                            ...
                            <td className="text-nowrap">
                              ...
                              >
                                {t("supplier_pages.dashboard.view")}
                              </Link>
                            </td>
                          </tr>
                        );
