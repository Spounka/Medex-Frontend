...
const Profile = () => {
          ...
          GetCountries()
            ...
            .then(() => {
              return GetState(parseInt(data.shipping_address.country)).then(
                (res) => {
                  if (res.length > 0) {
                    let s = res.find(
                      (x) => x.id == parseInt(data.shipping_address.state)
                    );
                    setState(s);
                    handleStateChange(data.shipping_address.country, s);
                  }
                }
              );
            })
            .then(() => {
              return GetCity(
                ...
                if (res.length > 0) {
                  let c = res.find(
                    (x) => x.id == parseInt(data.shipping_address.city)
                  );
                  setCity(c);
                }
              });
  ...
  const [products, setProducts] = useState([
    { name: "med", category: "dental", id: 1 },
    { name: "meds", category: "xRay", id: 2 },
    { name: "meds", category: "dental", id: 3 },
    { name: "meds", category: "xRay", id: 4 },
    { name: "meds", category: "chemical", id: 5 },
    { name: "meds", category: "xRay", id: 6 },
    { name: "meds", category: "Labs", id: 7 },
    { name: "Labs", category: "xRay", id: 8 },
    { name: "med", category: "dental", id: 9 },
    { name: "meds", category: "xRay", id: 10 },
    { name: "meds", category: "dental", id: 11 },
    { name: "meds", category: "xRay", id: 12 },
    { name: "meds", category: "chemical", id: 13 },
    { name: "meds", category: "xRay", id: 14 },
    { name: "meds", category: "Labs", id: 15 },
    { name: "Labs", category: "xRay", id: 16 },
  ]);
