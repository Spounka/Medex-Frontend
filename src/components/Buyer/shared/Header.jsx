          ...
          <div className="row">
            ...
            <div className="col-1 d-flex align-items-center">
              <div className="dropdown">
                ...
                >
                  {i18n.language === "en" ? (
                    <img src={enFlag} alt="EN" width="25" className="mx-1" />
                  ) : (
                    <img src={arFlag} alt="AR" width="25" className="mx-1" />
                  )}
                </Link>
                <ul className="dropdown-menu shadow" style={{ minWidth: "0" }}>
                  <li className="text-center">
                    <Link
                ...
                if (cat.parent === null) {
                  return cat.children_count !== 0 ? (
                    <button
                      key={`tablink_${cat.id}`}
                      className="tablinks"
                      onMouseOver={(event) => openTab(event, cat.slug)}
                    >
                      {cat?.name}
                    </button>
                  ) : (
                    <button
                      key={`tablink_${cat.id}`}
                      className="tablinks"
                      onMouseOver={(event) => openTab(event, "no_categories")}
                    >
                      {cat?.name}
                    </button>
                  );
