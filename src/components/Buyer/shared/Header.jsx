...
const Header = () => {
    ...
    return (
        <header>
            <nav className="navbar navbar-expand-lg py-2 py-md-2 shadow">
                <div className="container-xxl container-md">
                    <Link
                        to="/"
                        className="navbar-brand fs-1 text-color-blue fw-bold"
                    >
                        Medex
                    </Link>
                    <div className="ms-auto d-flex justify-content-center align-items-center gap-4 d-md-none">
                        <Link
                            to="wishlist"
                    ...
                    >
                        ...
                        >
                            <div className="d-flex justify-content-between align-items-center gap-lg-5 navbar__top-section">
                                <div>
            ...
            <nav className="navbar__bottom py-1 shadow d-none d-md-block position-relative">
                        ...
                        <div className="col-1 d-flex align-items-center">
                            <div className="dropdown">
                                ...
                                <ul className="dropdown-menu shadow">
                                    <li className="text-center">
                                        <Link
                                            className="dropdown-item d-flex justify-content-center gap-3 text-center"
                                            role="button"
                                            onClick={() =>
                                                i18n.changeLanguage("ar")
                                            }
