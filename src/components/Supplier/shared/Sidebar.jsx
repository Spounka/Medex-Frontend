          ...
          >
            ...
            >
              ...
              <li>
                ...
                >
                  <BsTruck size="1.5rem" />
                  <span className="ms-1">{t("supplier_sidebar.tracking")}</span>
                </Link>
              </li>
              <li>
                <Link
            ...
            >
              <li>
                ...
                >
                  ...
                  <span className="ms-1">{t("supplier_sidebar.language")}</span>
                  <IoIosArrowDown size="0.8rem" />
                </Link>
                <ul
                  className="collapse nav flex-column mx-3"
                ...
                >
                  <li>
                    ...
                    >
                      <img src={arFlag} alt="AR" width="25" height="25" />
                      <span className="text-dark">AR</span>
                    </Link>
                    <Link
